    ...
    <div className="p-6 max-w-3xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">Seguimiento y mantenimiento de vehículos</p>
        </div>
      </div>
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-10 flex flex-col items-center justify-center text-center gap-3">
        ...
        <p className="text-xs text-slate-600 max-w-xs">
          Registra tus vehículos, historial de servicios, gastos y próximas revisiones de mantenimiento.
        </p>
      </div>
    </div>
  )
