        ...
        <button type="button" onClick={() => { setFiltrosOpen(o => !o); setMetricasOpen(false) }}
          className={`flex items-center gap-1.5 h-9 px-3 rounded-lg text-sm font-medium border transition-all ${
            filtroEsActivo
              ...
              : "border-slate-300 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 hover:border-slate-300 dark:hover:border-slate-600"
          }`}>
