...
export function TrabajoSidebar() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800/60">
      {/* Logo */}
      <div className="h-14 flex items-center gap-3 px-5 border-b border-slate-200 dark:border-slate-800/60 shrink-0">
            ...
            <div className="space-y-0.5">
              {items.map(({ label, href, icon: Icon }) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`h-4 w-4 shrink-0 ${active ? "text-blue-500 dark:text-blue-400" : "text-slate-400 dark:text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-300"}`} />
