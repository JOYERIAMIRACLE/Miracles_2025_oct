export type FunnelEtapa   = "Lead" | "Prospecto" | "Cotizacion" | "Pedido"
export type SegmentoCliente = "Pareja" | "Matrimonio" | "Familiar" | "Personalizado"
export type EstadoCliente = "Activo" | "Inactivo"

export const FUNNEL_ETAPAS: FunnelEtapa[] = ["Lead", "Prospecto", "Cotizacion", "Pedido"]
...
export const FUNNEL_COLOR: Record<FunnelEtapa, string> = {
  ...
  "Cotizacion": "bg-amber-500/15 text-amber-300 border-amber-500/30",
