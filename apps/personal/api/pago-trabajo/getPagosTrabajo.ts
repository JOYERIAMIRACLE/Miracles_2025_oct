...
const fetchPagos = async () => {
  const res  = await fetch(`${BASE}/api/pago-trabajos?populate[0]=clienteTrabajo&populate[1]=proyecto&populate[2]=categoriaPago&pagination[pageSize]=200&sort[0]=createdAt:desc`)
