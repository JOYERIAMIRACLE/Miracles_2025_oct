...
const POPULATE = "populate[cliente]=true&populate[producto]=true&populate[centro_venta]=true&populate[lineas][populate][producto]=true&populate[cotizacionOrigen][fields][0]=numero&populate[envios][fields][0]=estado&populate[comprobantePago][fields][0]=url&populate[comprobantePago][fields][1]=name"
